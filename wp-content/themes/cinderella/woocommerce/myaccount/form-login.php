...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row"><?php _e( 'If you have shopped with us before, please enter your details.', 'cinderella' ); ?></p>

			<?php do_action( 'woocommerce_login_form_start' ); ?>

			<p class="form-row form-row-wide">
				<input type="text" placeholder="<?php _e( 'Username or email address', 'woocommerce' ); ?>" class="input-text" name="username" id="username" value="<?php if ( ! empty( $_POST['username'] ) ) echo esc_attr( $_POST['username'] ); ?>" />
			</p>
			<p class="form-row form-row-wide">
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-2">
		...
		<form method="post" class="register">
			...
			<p class="form-row"><?php _e( 'If you are a new customer please register here', 'cinderella' ); ?></p>
